...
#define encoder0PinB  3  // PC0;
#define E1            6
#define M1            A4
#define M2            A3  // motor's PWM outputs
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(2), encoderInt, CHANGE);  // encoder pin on interrupt 0 - pin 2
  attachInterrupt(digitalPinToInterrupt(3), countStep      , RISING);  // step  input on interrupt 1 - pin 3
